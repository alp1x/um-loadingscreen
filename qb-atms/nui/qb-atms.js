...
$(function () {
    $("body").on("keydown", function (key) {
        ...
        if ($('#pinContainer').is(':visible')) {
            if (key.which >= 48 && key.which <= 57) { // 48 - 57 (0-9 keys)
                ...
                let clickbtn = new Audio('clickatm.mp3');
                clickbtn.volume = 0.1;
                clickbtn.play();
    ...
    $(document).on('click', '[data-act=enterNumber]', function () {
        ...
        if (number == "ACCEPT") {
            ...
            if (currentVal == clientPin) {
                ...
                $('#errorMsg').removeClass('alert-info').addClass('alert-danger');
                $('#errorMsg').html('You have entered an incorrect pin, please try again.')
                let clickbtn = new Audio('erroratm.mp3');
                clickbtn.volume = 0.2;
                clickbtn.play();
                setTimeout(function () {
                    $('#errorMsg').addClass('alert-info').removeClass('alert-danger');
    ...
    $(".btn-secondary2, .nav-link").click(function () { /* modificato qui */
        let clickbtn = new Audio('click.mp3');
        clickbtn.volume = 0.1;
        clickbtn.play();
    });
    $(".btn-info").click(function () { /* modificato qui */
        let clickbtn = new Audio('clickatm.mp3');
        clickbtn.volume = 0.1;
        clickbtn.play();
    });
    $(".btn-danger").click(function () { /* modificato qui */
        let clickbtn = new Audio('erroratm.mp3');
        clickbtn.volume = 0.2;
        clickbtn.play();
    });
    $(".btn-success").click(function () { /* modificato qui */
        let clickbtn = new Audio('successatm.mp3');
        clickbtn.volume = 0.4;
        clickbtn.play();
    });
});

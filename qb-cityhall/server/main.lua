...
local availableJobs = { --[[ If you change this you need to go in app.js and search "JOBADD OR REMOVE" ]]
    ["trucker"] = "Trucker", --[[ do not exceed 13 characters otherwise you will have graphical problems ]]
    ["taxi"] = "Taxi",
    --["tow"] = "Tow Truck",
